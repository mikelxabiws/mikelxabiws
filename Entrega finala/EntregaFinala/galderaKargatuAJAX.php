...
if ($result->num_rows > 0) {
	while($row = $result->fetch_assoc()) {
			...
			//id eta eposta
			$galderaOsoa = "<legend>id: ".$id."</legend><fieldset>";
			...
			//$galderaOsoa = $galderaOsoa . "<a>Zailtasuna: <input id='zailtasuna".$id."' name='zailtasuna".$id."' disabled value='".$zailtasuna."'></a></br>";
			//gaia
			...
			$galderaOsoa = $galderaOsoa . "</fieldset></br>";
