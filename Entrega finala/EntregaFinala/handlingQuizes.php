...
if (!((isset($_SESSION['eposta'])) && $_SESSION['eposta']!='web000@ehu.es')){
	echo 'Ez zara ikaslea, ezin duzu orrialde hau ikusi.';
}else{
...
<html>
    ...
    <body>
		...
		<script type="text/javascript" language = "javascript">
			...
			function igoGaldera(){
				...
				xhrGaldera.send("eposta="+eps+"&galdera="+gal+"&erZuzen="+erZ+"&erOker1="+erO1+"&erOker2="+erO2+"&erOker3="+erO3+"&puntuazioa="+zail+"&arloa="+arl);
				document.getElementById('galderakIkusi2').disabled=true;
				ezabatu();
			}
	...
	<?php
		echo '<script>document.getElementById("eposta").value="'.$_SESSION['eposta'].'";document.getElementById("emaila").value="'.$_SESSION['eposta'].'";</script>';
	?>
