    ...
    <body>
        ...
        <form id="galderenF" name="galderenF" action="" onsubmit="return validateMyForm();" method="post">
			<legend>GALDERA GEHITU</legend>
				...
				Sartu zure eposta: <input type="text" value="<?php echo $_SESSION['eposta'];?>" id="eposta" name="eposta" placeholder="iabizenaXXX@ikasle.ehu.eus" pattern="[A-Za-z]{3,}[0-9]{3}@ikasle\.ehu\.eu?s"><br/><br/>
