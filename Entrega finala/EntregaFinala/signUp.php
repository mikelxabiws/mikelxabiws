...
<html>
    ...
    <body>
		...
		<legend>ERREGISTRATU</legend>
            ...
            Errepikatu pasahitza: <input type="password" id="pass2" name="pass2" pattern ="[A-Za-z0-9]{6,}"><br/><br/>
			Segurtasun galdera: <input type="text" id="segGaldera" name="segGaldera"><br/><br/>
            Segurtasun galderaren erantzuna: <input type="text" id="segErantzuna" name="segErantzuna"><br/><br/><br/>
        ...
        <script type="text/javascript" language = "javascript">
			...
			function validateMyForm(){
				if(($("#eposta").val()!=="")&&($("#izenAb").val()!=="")&&($("#eIzena").val()!=="")&&($("#pass1").val()!=="")&&($("#pass2").val()!=="")&&($("#segGaldera").val()!=="")&&($("#segErantzuna").val()!=="")){ 
		...
		<?php 
			...
			if (isset($_POST['izenAb']) && isset($_POST['eposta']) && isset($_POST['eIzena']) && isset($_POST['pass1']) && isset($_POST['pass2']) && isset($_POST['segGaldera']) && isset($_POST['segErantzuna'])){
				...
				$galdera=$_POST['segGaldera'];
				$erantzuna=$_POST['segErantzuna'];
				...
				if ($result->num_rows > 0) {
					...
					$sql="insert into erabiltzaile (eposta, izenAbizenak, erabiltzailea, pasahitza, segurtasunGaldera,segurtasunErantzuna) values ('$eposta','$izenAbizenak','$erabiltzailea','$zif','$galdera','$erantzuna')";
					$query=mysqli_query($con, $sql);
					if(!$query){
						...
						echo '<script>alert("Zuzenki erregistratu zara. Layout-era itzuliko zara.");location.href = "layout.php"</script>';
					}
				}
